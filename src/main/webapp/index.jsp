...
%>
        <tr>
            ...
            <td><a href="updateFromTextForm.jsp?playlistId=<%= spotify.getId() %>&operation=PREPEND">Add songs</a></td>
            <td><a href="updateFromTextForm.jsp?playlistId=<%= spotify.getId() %>&operation=REPLACE">Replace songs</a></td>
